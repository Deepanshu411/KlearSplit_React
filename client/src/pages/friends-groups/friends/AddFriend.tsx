        ...
        <DialogContent className="pt-4">
          ...
          <div className="max-h-60 overflow-auto mt-2 bg-gray-100 rounded-md shadow-inner p-2">
            {loading ? (
              ...
              <div className="p-2 border-b last:border-b-0 flex flex-col cursor-pointer hover:bg-gray-200 rounded-md">
          ...
          {searchCompleted &&
            ...
            !isValidEmailFormat(inputValue) && (
              <div className="p-2 border-b last:border-b-0 flex flex-col hover:bg-gray-200 rounded-md text-red-500">
                Please enter a valid email address.
              </div>
            )}
        </DialogContent>
        <DialogActions>
          <Button onClick={onAddFriendClose}>Cancel</Button>
